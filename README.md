...
- **관련 파일**: `docker-compose.yml`, `src/main/resources/application.properties`
...
- **관련 파일**: `src/main/java/com/gameexpert/chat/entity/ChatMessage.java`
...
- **관련 파일**: `player/controller/PlayerController.java`, `player/dto/CreatePlayerRequest.java`, `player/service/PlayerService.java`
...
- **관련 파일**: `world/service/WorldService.java`
...
- **관련 파일**: `chat/service/ChatService.java`
...
- **관련 파일**: `chat/controller/WorldChatController.java`
...
- **관련 파일**: `ws/NicknameHandshakeInterceptor.java`
...
- **관련 파일**: `config/WebSocketConfig.java`
...
- **관련 파일**: `ws/WorldSessionRegistry.java`
...
- **관련 파일**: `presence/PresenceService.java`
...
- **관련 파일**: `ws/MessageRouter.java`, `ws/handler/PingWsHandler.java`
...
- **관련 파일**: `ws/handler/MoveWsHandler.java`
...
- **관련 파일**: `ws/dto/ChatResponse.java`, `ws/handler/ChatWsHandler.java`
...
- **관련 파일**: `chat/service/LocalChatSender.java`, `chat/service/ChatDelivery.java`
...
- **관련 파일**: `ws/dto/OnlineUsersResponse.java`, `ws/handler/OnlineUsersWsHandler.java`
...
- **관련 파일**: `trial/entity/WorldTrialSite.java`
...
- **관련 파일**: `chat/service/ChatHistoryService.java`
...
- **관련 파일**: `chat/service/RecentChatCache.java`, `chat/service/RecentChatQueryService.java`
...
- **관련 파일**: `chat/service/ChatRateLimitService.java`
...
- **관련 파일**: `chat/relay/ChatRelay.java`, `chat/relay/ChatSubscriptionConfig.java`, `Dockerfile`, `docker-compose.yml`, `src/main/resources/application.properties` (`webcraft.chat.pubsub-enabled`)
